...
pcb_offset = 12; // offset center of PCB to center of left side panel
pcb_t = 1.6; // does NOT include margin as it is used for other calculations
pcb_l = 80.2; // includes margin
pcb_h = 25.2; // includes margin
pcb_components_w = 76;
...
difference() {
    ...
    translate_side("lid")
    right(pcb_offset - enclosure_length/2) {
        // button
        back(pcb_l/2 - 75.4)
        left(2.8)
